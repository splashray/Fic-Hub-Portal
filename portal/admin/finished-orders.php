...
// for deleting user
    ...
    if($msg)
        ...
        echo "<script type='text/javascript'> document.location = 'finished-orders.php'; </script>";
                ...
                <table class="table">
                        <thead>
                                  ...
                                  <th>Delete</th>
                                    ...
                                    <tbody>
<?php 
        $query = "SELECT * FROM orders WHERE order_approval = 'approved' ";
        ...
        while($row = mysqli_fetch_assoc($select_orders)){ 
            ...
            <td>
            <a href="finished-orders.php?delete= <?php echo $order_id; ?>"  onClick="return confirm('Do you really want to delete?');" > <i class="ti-trash"></i> </a>
            </td>
