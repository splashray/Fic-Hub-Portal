...
// for deleting user
    ...
    $msg=mysqli_query($con,"DELETE FROM message WHERE message_id='$message_id'");
    if($msg)
        {
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                   <ul class="breadcrumb-title">
                                                    ...
                                                    <li class="breadcrumb-item"><a href="total-users.php">View All Users</a>
                                                    </li>
...
<?php 
        ...
        while($row = mysqli_fetch_assoc($select_msg)){ 
            ...
            <td><?php echo $cnt;?></td>
            <td> <?php echo "MSG-0".$row['message_id']."-ER"; ?> </td>
