                                ...
                                <div class="page-body">
                                    ...
                                    <div class="card">
                                        <div class="card-header ">
                                            <h5>Ensure your basic details are all Correct...</h5>
                                            <span> <a href="change-personal-details.php"> If not click here to Edit Profile  </a> </span>
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $_SESSION['posting_date'] ?></td>
                                                        </tr>
                                                        <tr class="table-warning">
                                                            <th scope="row">6</th>
                                                            <th>Password</th>
                                                            <td><a href="change-personal-details.php#chgpass"> (Change Password) </a> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">7</th>
                                                            <th>New Info </th>
